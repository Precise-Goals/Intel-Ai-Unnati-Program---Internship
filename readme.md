...
│                                                                             │
│   ┌─────────────┐     ┌──────────────────────────────────────────────┐     │
│   │  YAML/API   │────▶│              ORCHESTRATOR                     │     │
│   │   Input     │     │  • Dependency Resolution (Topological Sort)   │     │
...
│          ▼                   ▼                   ▼                          │
│   ┌─────────────┐    ┌─────────────┐    ┌─────────────┐                    │
│   │   TOOLS     │    │   MEMORY    │    │  LOGGING    │                    │
│   │ • LLMTool   │    │ • Working   │    │ • FlowLog   │                    │
│   │ • FileTool  │    │ • Context   │    │ • Metrics   │                    │
│   │ • HTTPTool  │    │ • Results   │    │ • Audit     │                    │
│   │ • OpenVINO  │    │ • History   │    │ • JSONL     │                    │
│   └─────────────┘    └─────────────┘    └─────────────┘                    │
│                                                                             │
└─────────────────────────────────────────────────────────────────────────────┘
                                    │
